...
class Rossmann(object):
    def __init__(self):
        self.home_path = path_="/content/drive/MyDrive/ds_in_deploy/" #'C:/Users/paula/google_drive/#Projetos/repos/ds_em_producao/rossmann_store_sales_prediction/'

        """
        self.competition_distance_scaler   = pickle.load(open(self.home_path + 'api/parameter/competition_distance_scaler.pkl', 'rb'))
        self.competition_time_month_scaler = pickle.load(open(self.home_path + 'api/parameter/competition_time_month_scaler.pkl', 'rb'))
        self.promo2_time_week_scaler       = pickle.load(open(self.home_path + 'api/parameter/promo2_time_week_scaler.pkl', 'rb'))
        self.year_scaler                   = pickle.load(open(self.home_path + 'api/parameter/year_scaler.pkl', 'rb'))
        self.store_type_scaler             = pickle.load(open(self.home_path + 'api/parameter/store_type_scaler.pkl', 'rb'))
        ...
        self.promo2_time_week_scaler       = pickle.load(open(self.home_path + 'promo2_time_week_scaler.pkl', 'rb'))
    ...
    def feature_engineering(self, df2):
        ...
        df2['week_of_year'] = pd.to_datetime(df2['date']).dt.isocalendar().week
